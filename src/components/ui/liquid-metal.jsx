...
export const LiquidMetalButton = forwardRef((
    ...
    return (
        <button
            ...
            {...props}>
            <div
                className="relative w-full rounded-full overflow-hidden shadow-[0_20px_50px_-12px_rgba(0,0,0,0.25)]"
                ...
                <div
                    className={cn(
                        "relative z-10 w-full rounded-full flex items-center justify-center text-center",
